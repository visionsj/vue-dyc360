            ...
            <div id="register">
                <ul class="register_form" id="login">
                    <div class="reg_01">
                        <div class="list_title common_bg">
                            <ul>
                                ...
                                <li >
                                    <label class="reg_text_2">新密码</label>
                                ...
                                <li style="border-bottom: none" id="recommended_list">
                                    <label class="reg_text_2">再次密码</label>
                                    <input type="password" name="repeatPassword" v-model="repeatPassword" maxlength="20"  class="reg_text" placeholder="再次输入密码" >
                                </li>
                            </ul>
                        </div>
                    ...
                    <div id="btn"  class="mgt20">
                        <input type="button" id="subbt" class="common_btn" value='确认找回' @click="forgetPassword" >
                    </div>
...
export default {
    ...
    methods: {
        async forgetPassword(){
            ...
            let forgetPasswordInfo = await forgetLoginPassword(this.mobilePhone, this.verifyCode, MD5(this.password), MD5(this.repeatPassword));
        ...
        async getVerifyCode(){
            if(!this.rightPhoneNumber){
                ...
                let res = await getVerifyCode(this.mobilePhone, this.vcode, 2);
