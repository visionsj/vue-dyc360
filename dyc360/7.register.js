...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	                ...
	                return _regenerator2.default.wrap(function _callee$(_context) {
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            ...
	                            case 22:
	                                _context.next = 24;
	                                return (0, _getData.registerUser)(_this.mobilePhone, _this.sourceType, _this.mobilePhone, _this.vcode, _this.verifyCode, (0, _md.MD5)(_this.password), _this.inviteMobilePhone);
	                            ...
	                            case 24:
	                                ...
	                                if (registerInfo.data.retCode != "1") {
	                                    _this.showAlert = true;
	                                    _this.alertText = registerInfo.data.retMsg;
	                                } else {
	                ...
	                return _regenerator2.default.wrap(function _callee2$(_context2) {
	                    while (1) {
	                        switch (_context2.prev = _context2.next) {
	                            case 0:
	                                if (_this2.rightPhoneNumber) {
	                                    _context2.next = 6;
	                                    break;
	                                }

	                                _this2.showAlert = true;
	                                _this2.alertText = '手机号不正确';
	                                return _context2.abrupt('return');

	                            case 6:
	                                if (!_this2.showCodeBtn) {
	                                    _context2.next = 12;
	                                    break;
	                                }

	                                _this2.showAlert = true;
	                                _this2.alertText = '图片验证码不正确';
	                                return _context2.abrupt('return');

	                            case 12:
	                                _context2.next = 14;
	                                return (0, _getData.getVerifyCode)(_this2.mobilePhone, _this2.vcode, 1);
	                            ...
	                            case 14:
	                                ...
	                                _this2.computedTime = 60;

	                                _this2.timer = setInterval(function () {
	                                    _this2.computedTime--;
	                                    if (_this2.computedTime == 0) {
	                                        clearInterval(_this2.timer);
	                                    }
	                                }, 1000);

	                                _this2.showAlert = true;
	                                _this2.alertText = "发送短信成功";
	                                return _context2.abrupt('return');

	                            case 23:
	                                _this2.showAlert = true;
	                                _this2.alertText = res.data.retMsg;
	                                return _context2.abrupt('return');
	                ...
	                return _regenerator2.default.wrap(function _callee3$(_context3) {
	                    while (1) {
	                        switch (_context3.prev = _context3.next) {
	                            case 0:
	                                _this3.captchaCodeImg = 'https://m.duc360.com/vcode/gen-vcode.do?' + Math.random();
	        ...
	        checkImgCode: function checkImgCode() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "E:\\vue-dyc360\\app\\pages\\member\\register.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	...
	if (true) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-2eec88a4", Component.options)
	  } else {
	    hotAPI.reload("data-v-2eec88a4", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    on: {
	      "input": function($event) {
	        if ($event.target.composing) { return; }
	        _vm.sourceType = $event.target.value
	      }
	    }
	  }), _vm._v(" "), _c('div', {
	    attrs: {
	    ...
	    staticClass: "list_title common_bg"
	  }, [_c('ul', [_c('li', {
	    staticStyle: {
	      "box-shadow": "none"
	    }
	  }, [_c('label', {
	    staticClass: "reg_text_2"
	    ...
	    attrs: {
	      "src": _vm.captchaCodeImg
	    },
	    on: {
	      "click": _vm.getCaptchaCode
	    }
	  })])]), _vm._v(" "), _c('li', [_c('div', {
	    staticStyle: {
	      "position": "relative",
	    ...
	    directives: [{
	      name: "show",
	      rawName: "v-show",
	      value: (!_vm.computedTime),
	      expression: "!computedTime"
	    }],
	    class: !_vm.showCodeBtn ? 'reg_phone_code_send' : 'reg_phone_code_send disable_btn',
	    attrs: {
	      "id": "phone_send",
	      "disabled": _vm.showCodeBtn
	    },
	    on: {
	    ...
	    staticClass: "reg_phone_code_send disable_btn",
	    on: {
	      "click": function($event) {
	        $event.preventDefault();
	      }
	    }
	  }, [_vm._v("\r\n                                        已发送( " + _vm._s(_vm.computedTime) + "s )\r\n                                    ")])]), _vm._v(" "), _c('li', [_c('label', {
	    staticClass: "reg_text_2"
	    ...
	    staticClass: "reg_text_2"
	  }, [_vm._v("推荐人")]), _vm._v(" "), _c('input', {
	    directives: [{
	      name: "model",
	      rawName: "v-model",
	      value: (_vm.inviteMobilePhone),
	      expression: "inviteMobilePhone"
	    }],
	    staticClass: "reg_text",
	    attrs: {
	      "type": "tel",
	      "name": "inviteMobilePhone",
	      "maxlength": "16",
	    ...
	    on: {
	      "input": function($event) {
	        if ($event.target.composing) { return; }
	        _vm.inviteMobilePhone = $event.target.value
	      }
	    }
	  ...
	  })])])])]), _vm._v(" "), _vm._m(1), _vm._v(" "), (_vm.showAlert) ? _c('alert-tip', {
	    attrs: {
	  ...
	  return _c('div', {
	    staticClass: "reg_xieyi"
	  }, [_c('div', {
	    staticClass: "check_radio fl"
	  }, [_c('input', {
	    attrs: {
	      "name": "xieyi",
	      "id": "xieyi",
	    ...
	    staticClass: "radios fl"
	  }, [_vm._v("我已阅读并同意《"), _c('a', {
	    staticClass: "protocol_l",
	    attrs: {
	      "href": "agreement_reg.html"
	    }
	  }, [_vm._v("鼎有财会员合作协议")]), _vm._v("》")])])
	...
	if (true) {
	  module.hot.accept()
	  if (module.hot.data) {
	     __webpack_require__(3).rerender("data-v-2eec88a4", module.exports)
	  }
	}
